 ...
 *
 */
public class TestMgSellerCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected MgSellerService service;
    ...
    private static MgSeller mod =new MgSeller();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/manager/mgseller/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    MgSeller m2 = service.get(id);
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<MgSeller> page = new Page<>();
        MgSeller m1 = new MgSeller();
    ...
    public void testEfind() {
        MgSeller m1 = new MgSeller();
        List<MgSeller> list = service.find(m1);
    ...
    public void testGupdate() {
        MgSeller m1 = service.get(String.valueOf(id));
