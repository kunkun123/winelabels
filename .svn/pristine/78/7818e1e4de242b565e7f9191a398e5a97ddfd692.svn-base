package org.gecko.framework.test.manager;
...
/**
 *
 * TestMgProductlineCase
 * MgProductline测试用例
 * @author Gecko.Platform
 *
 */
public class TestMgProductlineCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected MgProductlineService service;
    ...
    private static MgProductline mod =new MgProductline();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/manager/mgproductline/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    MgProductline m2 = service.get(id);
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<MgProductline> page = new Page<>();
        MgProductline m1 = new MgProductline();
    ...
    public void testEfind() {
        MgProductline m1 = new MgProductline();
        List<MgProductline> list = service.find(m1);
    ...
    public void testGupdate() {
        MgProductline m1 = service.get(String.valueOf(id));
