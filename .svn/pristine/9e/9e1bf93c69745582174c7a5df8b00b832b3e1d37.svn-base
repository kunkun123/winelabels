package org.gecko.framework.test.memo;
...
import org.gecko.framework.memo.entity.MgMemo;
import org.gecko.framework.memo.service.MgMemoService;
 ...
 *
 */
public class TestMgMemoCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected MgMemoService service;
    ...
    private static MgMemo mod =new MgMemo();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/memo/mgmemo/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    MgMemo m2 = service.get(String.valueOf(id));
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<MgMemo> page = new Page<>();
        MgMemo m1 = new MgMemo();
    ...
    public void testEfind() {
        MgMemo m1 = new MgMemo();
        List<MgMemo> list = service.find(m1);
    ...
    public void testGupdate() {
        MgMemo m1 = service.get(String.valueOf(id));
