...
import org.gecko.framework.complaint.entity.CpComplaintproduct;
import org.gecko.framework.complaint.service.CpComplaintproductService;
...
/**
 *
 * TestCpComplaintproductCase
 * CpComplaintproduct测试用例
 * @author Gecko.Platform
 *
 */
public class TestCpComplaintproductCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected CpComplaintproductService service;
    ...
    private static CpComplaintproduct mod =new CpComplaintproduct();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/complaint/cpcomplaintproduct/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    CpComplaintproduct m2 = service.get(String.valueOf(id));
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<CpComplaintproduct> page = new Page<>();
        CpComplaintproduct m1 = new CpComplaintproduct();
    ...
    public void testEfind() {
        CpComplaintproduct m1 = new CpComplaintproduct();
        List<CpComplaintproduct> list = service.find(m1);
    ...
    public void testGupdate() {
        CpComplaintproduct m1 = service.get(String.valueOf(id));
