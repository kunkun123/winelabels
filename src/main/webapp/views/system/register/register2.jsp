...
<body>
	...
	<form method="post" enctype="multipart/form-data"
		action="/register/uploadInfo">
		<div style="float:left;margin-left:10%;">
			<h3>1.上传营业执照</h3>
			<span>上传营业执照，系统自动读取企业信息：</span> <input style="width:5%"
				class="form-control input-sm" name="uploadFile" type="file"
				id="uploadFile" />
			...
			<table>
				...
				<tr>
					...
					<td  class="col-md-10" colspan="6">
						<input class="form-control input-sm" width="120%" type="text" value="" readonly/>
					</td>
				</tr>
			</table>
		</div>
		<div style="float:left;" id="imgDiv"></div>

	</form>
	<div class="wizard-actions" style="margin-top:38%;">
	<hr/>
		<button class="btn  btn-prev">
			<i class="ace-icon fa fa-arrow-left"></i> 上一步
		</button>
		<button
			onclick="window.open('/views/system/register/register3.jsp','_self')"
...
$(function(){
		        ...
		        if("${imgUrl!=null}"=="true"){
		        	$("#imgDiv").html('<img src="${imgUrl}" style="margin-left:100%;margin-top:80%;"'+
