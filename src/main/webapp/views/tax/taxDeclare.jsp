...
<br>
                ...
                -->
				<button class="btn btn-primary btn-sm" type="button" onclick="taxDeclare()" >申报</button>
						<table class="">
                    		<tr style="height:10px"></tr>
                        <tr class="">
                            <td align="center" class=" " style="width:19%">
								<label for="name" class="bolder control-label blue">酒标编码:</label>
								<input style="width:73%" type="text" name="winelabelCode" class="form-control" id="winelabelCode">
                           </td><td align="center" class=" " style="width:19%">
							    <label for="name" class="bolder control-label blue">&nbsp;&nbsp;商品名称:</label>
								<input style="width:73%" type="text" name="productname" class="form-control" id="productname">
							</td> 
							<td align="center" class="" style="width:11%">
								...
								<select class="" name="producttype" id="producttype">
							     	...
							     	<option value="其他酒">其他</option>
							     </select>
							   </td><td align="" class=" " style="width:25%">
								<label class="blue bolder control-label"  for="name">
								采集时间:</label>
								<input style="width:38%" type="text" name="productname" class="form-control datepicker" id="startDate">
							
								<label class="control-label"  for="name">--</label>
								<input type="text" style="width:38%" name="productname" class="form-control datepicker" id="endDate">
							   </td>
							</tr>
							<tr style="height:10px"></tr>
							</table>
		...
		<div class="modal-content" >
			...
			<!--modal-body部分-->
				<div class="modal-body" id="notice">
					...
					<div class="" style="margin-top:11.5%">
...
$(function () {
	...
	function operateFormatter(value, row, index) {
	 	...
	 	return ["<button type='button' class='btn btn-link' onclick='javascript:view("+obj+");' style='margin-right:15px;'>查看酒标信息</button>"].join('');
...
function taxDeclare(){
	    ...
	    rows.forEach(function (t){
	     console.log(t);
	        ids+=t.temp1+","+t.temp2+","+t.temp3+","+t.temp4+","+t.starttime+"*"
	    });
	    console.log(ids);
	   window.location.href="/tax/alcirculation/taxDeclare?ids="+ids;
	       /*  $.ajax({
	            url : "/tax/alcirculation/taxDeclare?ids='1231,12312,1231'"+ids,
	            type : "get",
	            anysc:false,
	            //data: {ids:ids},
