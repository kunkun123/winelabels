...
import org.gecko.framework.manager.entity.AlProduct;
import org.gecko.framework.manager.service.AlProductService;
...
public class TestAlProductCase extends GeckoTestCase {
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/manager/alproduct/index")
