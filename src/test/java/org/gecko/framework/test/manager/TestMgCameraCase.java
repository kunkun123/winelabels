 ...
 *
 */
public class TestMgCameraCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected MgCameraService service;
    ...
    private static MgCamera mod =new MgCamera();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/manager/mgcamera/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    MgCamera m2 = service.get(id);
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<MgCamera> page = new Page<>();
        MgCamera m1 = new MgCamera();
    ...
    public void testEfind() {
        MgCamera m1 = new MgCamera();
        List<MgCamera> list = service.find(m1);
    ...
    public void testGupdate() {
        MgCamera m1 = service.get(String.valueOf(id));
