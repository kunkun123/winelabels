...
import org.gecko.framework.manager.entity.AlAlcohollable;
import org.gecko.framework.manager.service.AlAlcohollableService;
...
public class TestAlAlcohollableCase extends GeckoTestCase {
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/manager/alalcohollable/index")
