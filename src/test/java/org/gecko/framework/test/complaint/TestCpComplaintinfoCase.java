...
import org.gecko.framework.complaint.entity.CpComplaintinfo;
import org.gecko.framework.complaint.service.CpComplaintinfoService;
...
/**
 *
 * TestCpComplaintinfoCase
 * CpComplaintinfo测试用例
 * @author Gecko.Platform
 *
 */
public class TestCpComplaintinfoCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected CpComplaintinfoService service;
    ...
    private static CpComplaintinfo mod =new CpComplaintinfo();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/complaint/cpcomplaintinfo/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    CpComplaintinfo m2 = service.get(String.valueOf(id));
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<CpComplaintinfo> page = new Page<>();
    ...
    public void testEfind() {
        CpComplaintinfo m1 = new CpComplaintinfo();
        List<CpComplaintinfo> list = service.find(m1);
    ...
    public void testGupdate() {
        CpComplaintinfo m1 = service.get(String.valueOf(id));
