...
import org.gecko.framework.complaint.entity.CpComplaintsreport;
import org.gecko.framework.complaint.service.CpComplaintsreportService;
...
/**
 *
 * TestCpComplaintsreportCase
 * CpComplaintsreport测试用例
 * @author Gecko.Platform
 *
 */
public class TestCpComplaintsreportCase extends GeckoTestCase {
    protected final Logger logger = LoggerFactory.getLogger(getClass());

    @javax.annotation.Resource
    protected CpComplaintsreportService service;
    ...
    private static CpComplaintsreport mod =new CpComplaintsreport();
    ...
    public void testAControllers() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = post("/complaint/cpcomplaintsreport/index")
    ...
    public void testBGet() {
        logger.info("get object with: " + id);
                    CpComplaintsreport m2 = service.get(String.valueOf(id));
                assertTrue(m2 != null && m2.getId().equals(id));
    }

    @Test
    public void testCfindByPage() {
        Page<CpComplaintsreport> page = new Page<>();
        CpComplaintsreport m1 = new CpComplaintsreport();
    ...
    public void testEfind() {
        CpComplaintsreport m1 = new CpComplaintsreport();
        List<CpComplaintsreport> list = service.find(m1);
    ...
    public void testGupdate() {
        CpComplaintsreport m1 = service.get(String.valueOf(id));
